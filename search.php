...
<div class="container">
	...
	<?php
		$furnihome_post_type = isset( $_GET['search_posttype'] ) ? $_GET['search_posttype'] : '';
		if( ( $furnihome_post_type != '' ) &&  locate_template( 'templates/search-' . $furnihome_post_type . '.php' ) ){
			get_template_part( 'templates/search', $furnihome_post_type );
		}else{ 
			if( have_posts() ){
		?>
			...
			<div id="post-<?php the_ID();?>" <?php post_class( 'theme-clearfix' ); ?>>
				<div class="entry clearfix">
					...
					<div class="entry-content">
						...
						<div class="bl_read_more"><a href="<?php the_permalink(); ?>"><?php esc_html_e('Read more','furnihome')?><i class="fa fa-angle-double-right"></i></a></div>
