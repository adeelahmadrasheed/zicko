		...
		<?php if( $pfm == '' || $pfm == 'image' ){?>
			<?php if( has_post_thumbnail() ){ ?>
				<div class="entry-thumb single-thumb">
						<?php the_post_thumbnail('furnihome_blog_mobile');?>						
				</div>
			<?php }?>
		<?php } ?>
		...
		<div class="entry-content clearfix">
			<div class="entry-meta clearfix">
				...
				<div class="entry-comment">
					<a href="<?php comments_link(); ?>">
						...
						<?php echo $post->comment_count . ( ( $post->comment_count > 1 ) ? esc_html__(' Comments ', 'furnihome') : esc_html__(' Comments ', 'furnihome') ); ?>
					</a>
				</div>
			</div>
			<div class="entry-summary single-content ">
				...
				if ( preg_match('/<!--more(.*?)?-->/', $post->post_content, $matches) ) {
					echo wp_trim_words($post->post_content, 38, '...');
				} else {
					the_content('...');
				}		
			?>	
				...
				?>
					<div <?php post_class( $class_col ); ?> >
						...
						<div class="item-relate-img">
							<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('furnihome_related_mobile'); ?></a>
						</div>
						<?php } ?>
