...
global $woocommerce; ?>
<div class="top-form top-form-minicart furnihome-minicart4 pull-right">
	<div class="top-minicart-icon pull-right">
		<a class="cart-contents" href="<?php echo $woocommerce->cart->get_cart_url(); ?>" title="<?php esc_attr_e('View your shopping cart', 'furnihome'); ?>"><i class="fa fa-shopping-cart"></i><?php echo '<span class="minicart-number">'.$woocommerce->cart->cart_contents_count.'</span>';?>
