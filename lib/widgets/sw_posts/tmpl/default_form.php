...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id('category') ); ?>"><?php esc_html_e('Category Name', 'furnihome')?></label>
	<br />
	<?php echo $this->category_select('category', array('allow_select_all' => true), $categoryid); ?>
</p>

<p>
	<label for="<?php echo esc_attr( $this->get_field_id('orderby') ); ?>"><?php esc_html_e('Orderby', 'furnihome')?></label>
	<br />
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id('order') ); ?>"><?php esc_html_e('Order', 'furnihome')?></label>
	<br />
	<select class="widefat"
		...
		<?php } ?>>
			<?php esc_html_e('Descending', 'furnihome')?>
		</option>
		<option value="ASC" <?php if ($order=='ASC'){?> selected="selected"
		<?php } ?>>
			<?php esc_html_e('Ascending', 'furnihome')?>
		</option>
	</select>
</p>

<p>
	<label for="<?php echo esc_attr( $this->get_field_id('numberposts') ); ?>"><?php esc_html_e('Number of Posts', 'furnihome')?></label>
	<br />
	<input class="widefat"
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id('include') ); ?>"><?php esc_html_e('Include Posts ID', 'furnihome')?></label>
	<br />
	<input class="widefat"
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id('exclude') ); ?>"><?php esc_html_e('Exclude Posts ID', 'furnihome')?></label>
	<br />
	<input class="widefat"
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id('length') ); ?>"><?php esc_html_e('Excerpt length (in words): ', 'furnihome')?></label>
	<br />
	<input class="widefat"
