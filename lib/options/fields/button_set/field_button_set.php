<?php
class Furnihome_Options_button_set extends Furnihome_Options{	
	...
	*/
	function enqueue(){
		...
		wp_enqueue_style('furnihome-opts-jquery-ui-css');

		wp_enqueue_script(
			'furnihome-opts-field-button_set-js', 
			FURNI_OPTIONS_URL.'fields/button_set/field_button_set.js', 
